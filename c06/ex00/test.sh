...
BIG_AS_INT="${BIG_BUT_VALID_DOUBLE%.0}"
BIG_AS_FLOAT="${BIG_AS_INT}f"
TRUE_OVF_AS_INT="${TRUE_OVERFLOW_DOUBLE%.0}"
TRUE_OVF_AS_FLOAT="${TRUE_OVF_AS_INT}f"

check_case "$BIG_AS_INT"      "$IMP" "$IMP" "$IMP" "$IMP"
check_case "$BIG_AS_FLOAT"    "$IMP" "$IMP" "$IMP" "$IMP"
check_case "$TRUE_OVF_AS_INT"   "$IMP" "$IMP" "$IMP" "$IMP"
check_case "$TRUE_OVF_AS_FLOAT" "$IMP" "$IMP" "$IMP" "$IMP"
